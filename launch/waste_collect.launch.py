...
def generate_launch_description():
    ...
    world = os.path.join(get_package_share_directory('RadRoverRescue'),
                         'worlds', 'final3.world')
    
    model = os.path.join(get_package_share_directory('RadRoverRescue'),
                         'models')

    map = os.path.join(get_package_share_directory('RadRoverRescue'),
                         'maps', 'my_map2.yaml')
    print(map)
    launch_file_dir = os.path.join(get_package_share_directory('RadRoverRescue'), 'launch')
